...
function generatePoem(event) {
  ...
  let context = `You are a romantic, multilingual poet. Please generate a poem in the same language as ${instructions.value}, but sign off in English. Be concise and use as little words as possible. Generate all text in HTML format and separate all sentences with <br />.  All text align left and do not generate a title. Sign off with '- SheCodes AI'.`;
